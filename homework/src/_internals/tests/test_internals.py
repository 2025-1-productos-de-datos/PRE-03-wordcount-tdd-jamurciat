...
# from homework.src.wordcount import (  # type: ignore
#     count_words,
#     preprocess_lines,
#     split_into_words,
#     write_word_counts,
...
# from ..parse_args import parse_args  # type: ignore
# from ..read_all_lines import read_all_lines  # type: ignore
...
#     preproccessed = preprocess_lines(lines)
#     assert preproccessed == ["hello, world!", "python is great."]
